...
-- FILE_MANAGER = "yazi" # TODO not working right now
MENU = "wofi --show drun"
...
-- keybindings based on windows config
-- require("hy3") -- BUG currently has some issue keeping up with the stable hyprland release
require("hypr-dwindle")
